...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { description: @talk.description, speaker_id: @talk.speaker_id, url: @talk.url }
    end
  ...
  test "should update talk" do
    put :update, id: @talk, talk: { description: @talk.description, speaker_id: @talk.speaker_id, url: @talk.url }
    assert_redirected_to talk_path(assigns(:talk))
  end
